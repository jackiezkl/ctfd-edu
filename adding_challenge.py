...
#     xor_reder = csv.reader(xor_record)
  ...
  payload = '{"name":"XOR Challenge '+n+'","category":"Coordination","description":"Retrieve secret codes from **'+first_name+'** and **'+second_name+'**.Return the XOR of the two binary sequances.The flag is in the format <code>flag{01010101}</code>Please use private one-on-one chat function.","value":"24","state":"visible","type":"standard"}'
  update_session.post(
